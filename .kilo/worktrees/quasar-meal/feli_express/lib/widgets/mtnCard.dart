...
class MymtnCard extends StatefulWidget {
  @override
  _MymtnCardState createState() => _MymtnCardState();
}

class _MymtnCardState extends State<MymtnCard> {
            ...
            child: TextFormField(
              validator: (value) {
                if (value == null || value.isEmpty) {
                  return 'Please enter your MTN mobile money number';
                } else if (value.length < 10) {
                  return 'Mobile money number must be at least 10 characters';
                }

                return null;
              },
              decoration: InputDecoration(
                hintText: 'Example: 078*****564',
