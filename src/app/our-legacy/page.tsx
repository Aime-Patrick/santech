          ...
          <div className="grid gap-5 sm:grid-cols-2">
            {pillars.map((pillar, index) => (
              <div key={pillar.title} className="rounded-xl border border-slate-200 bg-white p-7 shadow-[0_18px_50px_rgba(15,23,42,0.05)]">
                ...
                <h3 className="mt-12 text-xl font-bold tracking-[-0.03em]">{pillar.title}</h3>
      ...
      <section className="px-6 py-20 sm:px-10 lg:px-16 lg:py-28">
        <div className="mx-auto grid max-w-7xl items-center gap-12 lg:grid-cols-[0.9fr_1.1fr]">
          <div>
            ...
            <h2 className="mt-5 text-3xl font-bold leading-[1] tracking-[-0.045em] sm:text-4xl">Recognition belongs to the ecosystem.</h2>
