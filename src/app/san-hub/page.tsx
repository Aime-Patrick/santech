...
import { SanHubEcosystem } from "@/components/san-hub-ecosystem";
  ...
  return (
    <PublicPage>
      ...
      <section className="px-6 py-20 text-center sm:px-10 lg:px-16 lg:py-28">
        ...
        <h2 className="font-exo mx-auto mt-4 max-w-3xl text-5xl font-black leading-[0.94] tracking-[-0.07em] sm:text-7xl">Build capability that travels.</h2>
